      ...
      <div className="w-full max-w-3xl">
        ...
        <Card className="w-full max-auto bg-white shadow-md border border-gray-200 px-6 py-12">
          ...
          <CardHeader className="pb-6">
            ...
            <p className="text-center text-xl font-normal">
              Enter your email & 4-digit OTP to reset password
            </p>
          </CardHeader>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-7">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="w-full h-12 px-3 py-2 mt-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent tracking-widest text-center"
