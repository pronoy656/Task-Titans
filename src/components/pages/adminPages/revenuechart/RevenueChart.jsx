...
import { ChevronDown } from "lucide-react";
import { useGetTopCategoriesQuery } from "../../../../redux/features/postOverviewChart/postOverViewChart";
// import { useGetTopCategoriesQuery } from "../../../../redux/features/postOverview/postOverviewApi";
  ...
  if (active && payload && payload.length) {
    ...
    return (
      <div className="bg-green-500 text-white px-3 py-2 rounded-md shadow-lg text-sm">
        ...
        <div className="text-lg font-medium">{data.revenue}%</div>
        <div className="text-lg font-medium">{data.value} posts</div>
      </div>
    );
  }
  return null;
